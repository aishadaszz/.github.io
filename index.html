	...
	<div id="about" class="about">
		<div class="container">
			...
			<div class="col-md-4 about-right">
				<ul>
					<h5>荣誉证书</h5>
					<li><span class="glyphicon glyphicon-menu-right" ></span> 河南工业大学专科学历</li>
					<li><span class="glyphicon glyphicon-menu-right"></span> 郑州大学自考本科学历</li>
					<li><span class="glyphicon glyphicon-menu-right"></span> 高级UI设计师证书</li>
					<li><span class="glyphicon glyphicon-menu-right"></span> 千典公司品牌最佳设计师荣誉</li>
		...
		<div class="container">
			...
			<div class="work-info"> 
				...
				<div class="col-md-6 work-right"> 
					<h5><span class="glyphicon glyphicon-briefcase"> </span> 河南千典文化传播有限公司</h5>
					<p>2017年5月，具有设计爱好的三人在一次电话共同组建三人小组，畅谈现如今设计行业发展趋势，6月结交在一起，共同协商千典品牌设计公司发展流程，7月正是注册河南千典文化传播有限公司成立。创定法定代表人,公司经营范围包括：设计、制作、代理、发布国内广告，企业管理咨询，企业营销策划，展览展示策划，文化艺术交流活动策划，平面设计，包装设计，企业形象策划等。 </p>
				</div>
				<div class="clearfix"> </div>
			</div>
			<div class="work-info"> 
				...
				<div class="col-md-6 work-left work-left2"> 
					<h5> 北京吉惠网络科技有限公司 <span class="glyphicon glyphicon-briefcase"> </span></h5>
					<p>2015年11月进入北京吉惠网络科技有限公司，主要负责网站后台维护，前端页面制作，设计。协同他人一起管理产品的上架，客户的沟通！ </p>
				</div>
				<div class="clearfix"> </div>
			</div>
			<div class="work-info"> 
				...
				<div class="col-md-6 work-right"> 
					<h5><span class="glyphicon glyphicon-briefcase"> </span> 中国酒商网</h5>
					<p>2015年3月，负责中国酒商网客户产品图的优化，制作！客户网站排版风格设计！ </p>
				</div>
				<div class="clearfix"> </div>
			</div>
			<div class="work-info"> 
				...
				<div class="col-md-6 work-left work-left2"> 
					<h5> 河南工业大学就读参加结业考试 <span class="glyphicon glyphicon-briefcase"></span> </h5>
					<p>2014年先后取得河南工业大学专科学历证书和郑州大学自考本科学历！ </p>
				</div>
				<div class="clearfix"> </div>
			</div>
		</div>
	...
	<div id="education" class="education">
		<div class="container">
			...
			<div class="work-info"> 
				...
				<div class="col-md-6 work-right"> 
					<h5><span class="glyphicon glyphicon-education"> </span> 河南工业大学</h5>
